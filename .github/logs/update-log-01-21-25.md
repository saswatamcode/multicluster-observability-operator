### Generated logs from GitHub Action: [12881088716](https://github.com/saswatamcode/multicluster-observability-operator/actions/runs/12881088716)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20250120232559-26b7da9b32cd
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20250120232559-26b7da9b32cd), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20250120232559-26b7da9b32cd), but does not contain package github.com/openshift/hypershift/api/v1beta1
