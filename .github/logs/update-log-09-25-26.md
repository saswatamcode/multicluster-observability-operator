### Generated logs from GitHub Action: [36128834898](https://github.com/saswatamcode/multicluster-observability-operator/actions/runs/36128834898)
...
- go: downloading github.com/openshift/hypershift v0.1.85
- go: downloading sigs.k8s.io/controller-runtime v0.14.4
- go: downloading github.com/openshift/hypershift/api v0.0.0-20260925093444-c5a935ddbb90
...
- go: downloading github.com/prometheus-community/prom-label-proxy v0.15.1
...
- go: downloading sigs.k8s.io/cluster-api/api v1.14.2
...
- go: downloading google.golang.org/genproto v0.0.0-20260921155816-b14227669459
- go: downloading google.golang.org/genproto/googleapis/rpc v0.0.0-20260921155816-b14227669459
- go: downloading github.com/blang/semver/v4 v4.0.0
- go: downloading go.starlark.net v0.0.0-20200306205701-8dd3e2ee1dd5
- go: downloading go.starlark.net v0.0.0-20260908191801-89a6a09411d5
- go: downloading github.com/jmespath/go-jmespath v0.4.0
- go: downloading golang.org/x/mod v0.10.0
- go: downloading golang.org/x/mod v0.41.0
- go: all: module github.com/grpc-ecosystem/go-grpc-middleware/v2@upgrade found (v2.3.4), but does not contain package github.com/grpc-ecosystem/go-grpc-middleware/v2/interceptors/tags
- go: all: module github.com/grpc-ecosystem/go-grpc-middleware/v2@upgrade found (v2.3.4), but does not contain package github.com/grpc-ecosystem/go-grpc-middleware/v2/interceptors/tracing
- go: all: module github.com/grpc-ecosystem/go-grpc-middleware/v2@upgrade found (v2.3.4), but does not contain package github.com/grpc-ecosystem/go-grpc-middleware/v2/util/metautils
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20260925093444-c5a935ddbb90), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20260925093444-c5a935ddbb90), but does not contain package github.com/openshift/hypershift/api/v1beta1
...
- go: all: module github.com/thanos-io/thanos@upgrade found (v0.42.4), but does not contain package github.com/thanos-io/thanos/pkg/httpconfig
...
- go: all: module golang.org/x/tools@upgrade found (v0.50.0), but does not contain package golang.org/x/tools/go/internal/packagesdriver
- go: all: module golang.org/x/tools@upgrade found (v0.50.0), but does not contain package golang.org/x/tools/internal/event/tag
- go: all: module golang.org/x/tools@upgrade found (v0.50.0), but does not contain package golang.org/x/tools/internal/tokeninternal
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/internal/grpcrand
- go: all: module open-cluster-management.io/addon-framework@upgrade found (v1.3.1), but does not contain package open-cluster-management.io/addon-framework/pkg/addonmanager/controllers/addoninstall
- go: all: module open-cluster-management.io/addon-framework@upgrade found (v1.3.1), but does not contain package open-cluster-management.io/addon-framework/pkg/addonmanager/controllers/managementaddonconfig
- go: all: module open-cluster-management.io/addon-framework@upgrade found (v1.3.1), but does not contain package open-cluster-management.io/addon-framework/pkg/basecontroller/factory
- go: all: module open-cluster-management.io/addon-framework@upgrade found (v1.3.1), but does not contain package open-cluster-management.io/addon-framework/pkg/manager/controllers/addonconfiguration
- go: all: module open-cluster-management.io/addon-framework@upgrade found (v1.3.1), but does not contain package open-cluster-management.io/addon-framework/pkg/manager/controllers/addonowner
- go: all: module sigs.k8s.io/kustomize/api@upgrade found (v0.21.1), but does not contain package sigs.k8s.io/kustomize/api/image
- go: all: module sigs.k8s.io/kustomize/api@upgrade found (v0.21.1), but does not contain package sigs.k8s.io/kustomize/api/konfig/builtinpluginconsts
- go: all: module sigs.k8s.io/kustomize/api@upgrade found (v0.21.1), but does not contain package sigs.k8s.io/kustomize/api/loader
- go: all: module sigs.k8s.io/kustomize/kyaml@upgrade found (v0.21.1), but does not contain package sigs.k8s.io/kustomize/kyaml/fn/runtime/starlark
- go: all: module sigs.k8s.io/kustomize/kyaml@upgrade found (v0.21.1), but does not contain package sigs.k8s.io/kustomize/kyaml/internal/forked/github.com/go-yaml/yaml
- go: all: module sigs.k8s.io/kustomize/kyaml@upgrade found (v0.21.1), but does not contain package sigs.k8s.io/kustomize/kyaml/internal/forked/github.com/qri-io/starlib/util
