### Generated logs from GitHub Action: [33864825886](https://github.com/saswatamcode/multicluster-observability-operator/actions/runs/33864825886)
...
- go: downloading github.com/openshift/hypershift v0.1.82
...
- go: downloading github.com/prometheus-operator/prometheus-operator v0.93.1
...
- go: downloading github.com/stolostron/observatorium-operator v0.0.0-20260821125221-4e7355633349
...
- go: downloading github.com/prometheus-community/prom-label-proxy v0.15.0
...
- go: downloading sigs.k8s.io/cluster-api/api v1.14.1
...
- go: downloading github.com/go-openapi/swag v0.29.1
...
- go: downloading go.starlark.net v0.0.0-20260828210309-6dd8f160a37f
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20260904071937-c81e6d282c61), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20260904071937-c81e6d282c61), but does not contain package github.com/openshift/hypershift/api/v1beta1
...
- go: all: module golang.org/x/tools@upgrade found (v0.49.0), but does not contain package golang.org/x/tools/go/internal/packagesdriver
- go: all: module golang.org/x/tools@upgrade found (v0.49.0), but does not contain package golang.org/x/tools/internal/event/tag
- go: all: module golang.org/x/tools@upgrade found (v0.49.0), but does not contain package golang.org/x/tools/internal/tokeninternal
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/internal/grpcrand
